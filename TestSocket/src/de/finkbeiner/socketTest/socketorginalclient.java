...
public class socketorginalclient {
        ...
        public void sendFigureToServer(Figure figure) {
            ...
            try {
				objectOutputStream.writeObject(figure.getCarriedItem());
				objectOutputStream.flush();
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
        ...
        public class MessagesFromServerListener implements Runnable {
                ...
                public void run() {
                        ...
                        try {            
                        	...
                        	while((readedObject = (Object) objectInputStream.readObject()) != null){
                        		...
                        		if (readedObject instanceof Figure) {
    								...
    								System.out.println(figure.getCarriedItem());
    							}    
                        	}
